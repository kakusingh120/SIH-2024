...
function bganim() {
    document.querySelectorAll(".section").forEach(function (e) {
      ScrollTrigger.create({
        ...
        // markers:true,
        onEnter: function () {
          if (e.dataset.color === "transparent") {
            document.querySelector("#nav").style.backgroundColor = "transparent"; // Set to transparent
          } else {
            const themeColor = getComputedStyle(document.body).getPropertyValue(`--${e.dataset.color}`).trim();
            document.querySelector("#nav").style.backgroundColor = themeColor;
          }
